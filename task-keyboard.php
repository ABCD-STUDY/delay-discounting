...
var test_block = {
    type: 'single-stim',
    choices: ['8','9',jsPsych.pluginAPI.convertKeyCharacterToKeyCode('esc'), 37, 39],
    timeline: all_trials,
	...
	if (data.key_press == jsPsych.pluginAPI.convertKeyCharacterToKeyCode('8') || data.key_press == 37)
	    gn_keystroke = 1;
	if (data.key_press == jsPsych.pluginAPI.convertKeyCharacterToKeyCode('9') || data.key_press == 39)
	    gn_keystroke = 3;
